...
export type UserProfile = {
  ...
  part_country_living_str: string;
  part_state: string;
  part_state_str: string;
  part_city: string;
  part_city_str: string;
  part_frm_age: string;
  part_to_age: string;
  part_height: string;
  part_height_str: string;
  part_height_to: string;
  part_height_to_str: string;
  partBodytype: string;
  partComplexion: string;
  part_diet: string;
  part_drink: string;
  part_smoke: string;
  part_education: string;
  part_education_str: string;
  part_employee_in: string;
  partDesignation: string;
  partDesignationStr: string;
  part_occupation: string;
  part_occupation_str: string;
  part_income: string;
  part_manglik: string;
  partStar: string;
  partStarStr: string;
